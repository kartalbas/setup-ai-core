...
- `.ai-core/docs/<harness>/`: the project's documents, `glossary.md` among them: one concept, one word, and where it lives; a new name enters it with the change that introduces it.
